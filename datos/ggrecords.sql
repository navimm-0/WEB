...
-- Tabla: vacante (antes Vacante, renombrado a minúscula)
...
CREATE TABLE postulaciones (
  ...
  puntaje_cv DECIMAL(5,2) DEFAULT NULL, -- nuevo campo para promedio
  PRIMARY KEY (id),
  UNIQUE KEY unq_postulacion_unica (id_usuario, id_vacante), -- evitar duplicados
