...
<main class="contenido-usuario">
    <h1>Mi Perfil</h1>
    <form method="POST" action="../scripts/actualizar_usuario.php" class="formulario-vacante">
        <input type="hidden" name="id" value="<?php echo $datos['id'] ?? ''; ?>">

        <label for="nombre">Nombre:</label>
        <input type="text" name="nombre" id="nombre" value="<?php echo htmlspecialchars($datos['nombre'] ?? ''); ?>" required>

        <label for="correo">Correo:</label>
        <input type="email" name="correo" id="correo" value="<?php echo htmlspecialchars($datos['correo'] ?? ''); ?>" required>

        <label for="usuario">Usuario:</label>
        <input type="text" name="usuario" id="usuario" value="<?php echo htmlspecialchars($datos['usuario'] ?? ''); ?>" readonly>
